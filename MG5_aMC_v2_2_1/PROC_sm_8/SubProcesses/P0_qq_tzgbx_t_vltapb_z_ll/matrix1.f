...
C     
C     Process: u d~ > t z g b~ WEIGHTED=7
C     *   Decay: t > vt ta+ b WEIGHTED=4
C     *   Decay: z > e- e+ WEIGHTED=2
C     Process: c s~ > t z g b~ WEIGHTED=7
C     *   Decay: t > vt ta+ b WEIGHTED=4
C     *   Decay: z > e- e+ WEIGHTED=2
C     Process: u d~ > t z g b~ WEIGHTED=7
C     *   Decay: t > vt ta+ b WEIGHTED=4
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_1(W(1,4),W(1,5),GC_11,MDL_MT,MDL_WT,W(1,9))
      CALL FFV2_5_2(W(1,1),W(1,3),GC_51,GC_58,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1_2(W(1,6),W(1,5),GC_11,MDL_MB,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 21
      ...
      CALL FFV1_1(W(1,8),W(1,5),GC_11,MDL_MT,MDL_WT,W(1,15))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,6),W(1,15),W(1,14),GC_100,AMP(22))
      CALL FFV1_2(W(1,7),W(1,5),GC_11,MDL_MB,ZERO,W(1,15))
