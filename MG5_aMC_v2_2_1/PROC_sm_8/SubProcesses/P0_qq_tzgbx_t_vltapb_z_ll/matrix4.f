...
C     
C     Process: d u~ > t~ z g b WEIGHTED=7
C     *   Decay: t~ > vt~ ta- b~ WEIGHTED=4
C     *   Decay: z > e- e+ WEIGHTED=2
C     Process: s c~ > t~ z g b WEIGHTED=7
C     *   Decay: t~ > vt~ ta- b~ WEIGHTED=4
C     *   Decay: z > e- e+ WEIGHTED=2
C     Process: d u~ > t~ z g b WEIGHTED=7
C     *   Decay: t~ > vt~ ta- b~ WEIGHTED=4
...
C     ----------
      ...
      CALL VXXXXX(P(0,8),ZERO,NHEL(8),+1*IC(8),W(1,5))
      CALL OXXXXX(P(0,9),MDL_MB,NHEL(9),+1*IC(9),W(1,6))
      CALL FFV1_2(W(1,1),W(1,5),GC_11,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_5_1(W(1,2),W(1,3),GC_51,GC_58,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_3_2(W(1,1),W(1,3),GC_50,GC_58,ZERO,ZERO,W(1,12))
      CALL FFV2_3(W(1,9),W(1,6),GC_100,MDL_MW,MDL_WW,W(1,13))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,12),W(1,2),W(1,13),GC_100,AMP(6))
      CALL FFV2_3(W(1,1),W(1,2),GC_100,MDL_MW,MDL_WW,W(1,14))
...
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,1),W(1,11),W(1,13),GC_100,AMP(10))
      CALL FFV1_1(W(1,2),W(1,5),GC_11,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,12),W(1,13),W(1,10),GC_100,AMP(11))
      CALL FFV2_3(W(1,1),W(1,13),GC_100,MDL_MW,MDL_WW,W(1,9))
...
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,1),W(1,15),W(1,10),GC_100,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,4),W(1,7),W(1,9),GC_100,AMP(15))
      CALL FFV1_1(W(1,6),W(1,5),GC_11,MDL_MB,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,1),W(1,11),W(1,15),GC_100,AMP(20))
      CALL FFV1_2(W(1,12),W(1,5),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,15),W(1,2),W(1,10),GC_100,AMP(21))
      CALL FFV1_2(W(1,8),W(1,5),GC_11,MDL_MT,MDL_WT,W(1,15))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,15),W(1,6),W(1,14),GC_100,AMP(22))
      CALL FFV1_1(W(1,7),W(1,5),GC_11,MDL_MB,ZERO,W(1,15))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,4),W(1,15),W(1,14),GC_100,AMP(23))
      CALL FFV1_1(W(1,11),W(1,5),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,1),W(1,15),W(1,10),GC_100,AMP(24))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=-AMP(6)-AMP(7)-AMP(8)-AMP(9)-AMP(10)-AMP(16)-AMP(17)
     $ -AMP(18)-AMP(19)-AMP(20)-AMP(22)-AMP(23)
      JAMP(2,1)=-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(11)-AMP(12)
