...
C     *   Decay: t~ > vt~ ta- b~ WEIGHTED=4
C     *   Decay: z > ta- ta+ WEIGHTED=2
...
C     ----------
      ...
      CALL IXXXXX(P(0,7),MDL_MTA,NHEL(7),-1*IC(7),W(1,5))
      CALL FFV2_4_3(W(1,5),W(1,6),GC_50,GC_59,MDL_MZ,MDL_WZ,W(1,3))
