...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! g u > vt ta+ b ta- ta+ d b~
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! g d > vt~ ta- b~ ta- ta+ u b
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! g u~ > vt~ ta- b~ ta- ta+ d~ b
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! g d~ > vt ta+ b ta- ta+ u~ b~
      ENDIF
      RETURN
      END
